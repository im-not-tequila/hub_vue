<template>
  <header
      class="sticky top-0 flex w-auto bg-white border-gray-200 z-40 dark:border-gray-800 dark:bg-gray-900 lg:border-b"
  >
    <div class="flex items-center w-full px-3 py-3 sm:gap-4 lg:px-6 lg:py-4">
      <div
