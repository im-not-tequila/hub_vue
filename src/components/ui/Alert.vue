<template>
  <div :class="['rounded-xl border p-4 w-full h-full', variantClasses[variant].container]">
...
import { SuccessIcon, ErrorIcon, WarningIcon, InfoCircleIcon } from '@/components/icons'
